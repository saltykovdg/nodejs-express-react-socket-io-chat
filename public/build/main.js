...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1),
	    ...
	    ChatBox = __webpack_require__(/*! ./components/ChatBox/ChatBox.jsx */ 159);
	
	ReactDOM.render(React.createElement(
	    'h1',
	    { className: 'page-header' },
	    'My first chat on React and Socket.IO'
	), document.getElementById('chat-header'));
	
	ReactDOM.render(React.createElement(ChatBox, null), document.getElementById("chat-box"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1),
	    ReactDOM = __webpack_require__(/*! react-dom */ 158),
	    ChatMessageInput = __webpack_require__(/*! ./ChatMessageInput.jsx */ 160),
	    ChatMessageList = __webpack_require__(/*! ./ChatMessageList.jsx */ 161);
	...
	var ChatBox = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(ChatMessageInput, { onClick: this.handleMessageSend }),
	            React.createElement(ChatMessageList, { items: this.state.items })
	        );
	    }
	});
...
/* 160 */
/*!*****************************************************!*\
  !*** ./src/components/ChatBox/ChatMessageInput.jsx ***!
  \*****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatMessageInput = function ChatMessageInput(props) {
	    return React.createElement(
	        "div",
	        { className: "form-group", id: "chat-message-input" },
	        React.createElement("input", { id: "author", type: "text", className: "form-control", placeholder: "Введите ваше имя" }),
	        React.createElement(
	            "div",
	            { className: "form-group" },
	            React.createElement("label", { htmlFor: "messageArea" }),
	            React.createElement("textarea", { className: "form-control", id: "messageArea", name: "text", placeholder: "Введите сообщение",
	                rows: "3" })
	        ),
	        React.createElement(
	            "span",
	            { className: "pull-right chars-remaining-pf" },
	            React.createElement("span", { id: "charRemainingCntFld" }),
	            React.createElement(
	                "button",
	                { id: "postBtn", className: "btn btn-default", onClick: props.onClick },
	                "Отправить сообщение"
	            )
	        )
	    );
...
/* 161 */
/*!****************************************************!*\
  !*** ./src/components/ChatBox/ChatMessageList.jsx ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatMessageList = function ChatMessageList(props) {
	    var createMessage = function createMessage(item) {
	        return React.createElement(
	            'p',
	            { key: item.date },
	            '[',
